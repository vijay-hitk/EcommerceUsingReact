...
export const fetchproducts = createAsyncThunk('product/fetchproducts', async () => {
    const resp = await axios
        .get(`https://my-json-server.typicode.com/vijay-hitk/Ecommerce-skill-test/products`);
    return resp.data;
})
...
export const addproducts = createAsyncThunk(
    ...
    async ({ values }) => {
        return fetch(`https://my-json-server.typicode.com/vijay-hitk/Ecommerce-skill-test/products`, {
            method: 'POST',
            headers: {
...
export const deleteproduct = createAsyncThunk(
    ...
    async (id) => {
        return fetch(`https://my-json-server.typicode.com/vijay-hitk/Ecommerce-skill-test/products/${id}`, {
            method: 'DELETE'
        })
            .then((res) => { res.json() })
